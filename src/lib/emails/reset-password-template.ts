/**
 * Password reset email template, sent via Resend
 */
        ...
        <table width="480" cellpadding="0" cellspacing="0" style="background:#16131e;border:1px solid #231f2e;border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:12px 36px 0;color:#8b84a0;font-size:14px;line-height:1.7;">
              Click the button below to choose a new password for your account. This link expires in 1 hour.
            </td>
          </tr>
          <tr>
              ...
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="border-radius:10px;background:linear-gradient(135deg,#f43f8e,#8b5cf6);">
                    <a href="${resetUrl}" style="display:inline-block;padding:12px 32px;color:#fff;font-size:14px;font-weight:700;text-decoration:none;">
                      Reset my password
                    </a>
                  </td>
                </tr>
