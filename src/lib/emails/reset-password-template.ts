        ...
        <table width="480" cellpadding="0" cellspacing="0" style="background:#16131e;border:1px solid #231f2e;border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:36px 36px 0;">
              <img src="{{ .SiteURL }}/logo-email.svg" width="110" height="30" alt="Vaulty" style="display:block;" />
            </td>
          </tr>
          <tr>
...
<table width="480" cellpadding="0" cellspacing="0" style="background:#16131e;border:1px solid #231f2e;border-radius:16px;overflow:hidden;">
<tr><td style="height:3px;background:linear-gradient(135deg,#f43f8e,#8b5cf6);"></td></tr>
<tr><td style="padding:36px 36px 0;"><img src="{{ .SiteURL }}/logo-email.svg" width="110" height="30" alt="Vaulty" style="display:block;" /></td></tr>
